...
The tSAC cosmos is structured around three fundamental realms:
...
Between the Living World and each cosmic plane lies the Veil — a semi-permeable membrane that regulates the flow of spiritual energy between realms. The Veil is not a physical structure but a metaphysical boundary maintained by the Protectors.

The integrity of the Veil is the central concern of the Veil Guard faction.
...
1. **The Primordials** — ancient forces that predate the current structure; mostly inert
2. **The Protectors** — semi-divine beings charged with maintaining the realms
3. **Shadebound and Spiritlocked** — mortals with unusual connections to the planes
4. **Mortals** — inhabitants of the Living World
...
- [The Living World](living_world.md)
- [The Protectors](protectors.md)
